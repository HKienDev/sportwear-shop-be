...
var Container = React2.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { children, style } = _b, props = __objRest2(_b, ["children", "style"]);
...
var Head = React3.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { children } = _b, props = __objRest3(_b, ["children"]);
  ...
  (_a2, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      __spreadProps4(__spreadValues4({}, props), {
        ref,
        style: __spreadValues4(__spreadValues4({}, withMargin({ m, mx, my, mt: mt2, mr: mr2, mb, ml: ml2 })), style),
        children
      })
    );
  }
...
var Hr = React5.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { style } = _b, props = __objRest5(_b, ["style"]);
...
var Html = React6.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { children, lang = "en", dir = "ltr" } = _b, props = __objRest6(_b, ["children", "lang", "dir"]);
...
var Img = React7.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { alt, src, width, height, style } = _b, props = __objRest7(_b, ["alt", "src", "width", "height", "style"]);
...
var Link = React8.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { target = "_blank", style } = _b, props = __objRest8(_b, ["target", "style"]);
...
var Preview = React9.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { children = "" } = _b, props = __objRest9(_b, ["children"]);
...
var Section = React10.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { children, style } = _b, props = __objRest10(_b, ["children", "style"]);
...
var kr = __toESM(require_react(), 1);
...
function Ci() {
  ...
  class h extends Error {
    ...
    showSourceCode(l) {
      ...
      if (l) {
        let { bold: v, gray: g, red: n } = u.createColors(true);
    ...
    raw(l, f, s) {
        ...
        return this.beforeAfter(l, s);
      {
        ...
        this[r] ? c = this[r](e, l) : e.walk((i) => {
          if (c = i.raws[f], typeof c < "u") return false;
        });
      }
...
function nt() {
  ...
  class i extends h {
    ...
    each(v) {
      ...
      for (; this.indexes[g] < this.proxyOf.nodes.length && (n = this.indexes[g], d = v(this.proxyOf.nodes[n], n), d !== false); )
        this.indexes[g] += 1;
    ...
    getProxyProcessor() {
      return {
        ...
        set(v, g, n) {
          return v[g] === n || (v[g] = n, (g === "name" || g === "params" || g === "selector") && v.markDirty()), true;
        }
      };
    }
    index(v) {
    ...
    insertBefore(v, g) {
      let n = this.index(v), d = n === 0 ? "prepend" : false, _ = this.normalize(
        g,
    ...
    walk(v) {
      return this.each((g, n) => {
        ...
        return d !== false && g.walk && (d = g.walk(v)), d;
      });
    }
    walkAtRules(v, g) {
  ...
  return i.registerParse = (o) => {
    ...
    o.type === "atrule" ? Object.setPrototypeOf(o, f.prototype) : o.type === "rule" ? Object.setPrototypeOf(o, t.prototype) : o.type === "decl" ? Object.setPrototypeOf(o, a.prototype) : o.type === "comment" ? Object.setPrototypeOf(o, u.prototype) : o.type === "root" && Object.setPrototypeOf(o, c.prototype), o[l] = true, o.nodes && o.nodes.forEach((v) => {
      i.rebuild(v);
    });
  }, Ir;
}
...
`), this.css += v + "/*# sourceMappingURL=" + o + " */";
    ...
    applyPrevMaps() {
      for (let o of this.previous()) {
        ...
        this.mapOpts.sourcesContent === false ? (n = new l(o.text), n.sourcesContent && (n.sourcesContent = null)) : n = o.consumer(), this.map.applySourceMap(n, v, this.toUrl(this.path(g)));
      }
    }
    clearAnnotation() {
...
`), v = w.length - d) : v += w.length, y && x !== "start") {
    ...
    isInline() {
      ...
      return typeof o < "u" && o !== true ? false : this.previous().length ? this.previous().some((v) => v.inline) : true;
    }
    isMap() {
  ...
  class t {
      ...
      for (; !this.tokenizer.endOfFile(); ) {
        if (r = this.tokenizer.nextToken(), o = r[0], o === "(" || o === "[" ? w.push(o === "(" ? ")" : "]") : o === "{" && w.length > 0 ? w.push("}") : o === w[w.length - 1] && w.pop(), w.length === 0)
          if (o === ";") {
            ...
            if (_.length > 0) {
              for (g = _.length - 1, v = _[g]; v && v[0] === "space"; )
                v = _[--g];
    ...
    colon(r) {
      ...
      for (let [n, d] of r.entries()) {
        if (v = d, g = v[0], g === "(" && (i += 1), g === ")" && (i -= 1), i === 0 && g === ":")
          if (!o)
            this.doubleColon(v);
          else {
    ...
    decl(r, i) {
      ...
      this.init(o, r[0][2]);
      let v = r[r.length - 1];
      for (v[0] === ";" && (this.semicolon = true, r.pop()), o.source.end = this.getPosition(
        v[3] || v[2] || c(r)
      ...
      for (; r.length; )
        if (g = r.shift(), g[0] === ":") {
          ...
          g[0] === "word" && /\w/.test(g[1]) && this.unknownWord([g]), o.raws.between += g[1];
    ...
    other(r) {
      let i = false, o = null, v = false, g = null, n = [], d = r[1].startsWith("--"), _ = [], w = r;
      for (; w; ) {
      ...
      if (this.tokenizer.endOfFile() && (i = true), n.length > 0 && this.unclosedBracket(g), i && v) {
        if (!d)
    ...
    raw(r, i, o, v) {
      let g, n, d = o.length, _ = "", w = true, y, x;
      for (let m = 0; m < d; m += 1)
        g = o[m], n = g[0], n === "space" && m === d - 1 && !v ? w = false : n === "comment" ? (x = o[m - 1] ? o[m - 1][0] : "empty", y = o[m + 1] ? o[m + 1][0] : "empty", !s[x] && !s[y] ? _.slice(-1) === "," ? w = false : _ += g[1] : w = false) : _ += g[1];
      if (!w) {
        let m = o.reduce((O, A) => O + A[1], "");
        r.raws[i] = { raw: m, value: _ };
      }
      r[i] = _;
    }
    rule(r) {
...
function gl() {
  ...
  function n(x) {
    ...
    return x.type === "decl" ? m = x.prop.toLowerCase() : x.type === "atrule" && (m = x.name.toLowerCase()), m && x.append ? [
      ...
      O + "Exit",
      O + "Exit-" + m
    ] : m ? [O, O + "-" + m, O + "Exit", O + "Exit-" + m] : x.append ? [O, v, O + "Exit"] : [O, O + "Exit"];
  }
  function d(x) {
    let m;
    return x.type === "document" ? m = ["Document", v, "DocumentExit"] : x.type === "root" ? m = ["Root", v, "RootExit"] : m = n(x), {
      eventIndex: 0,
      events: m,
      iterator: 0,
      node: x,
  ...
  function _(x) {
    return x[c] = false, x.nodes && x.nodes.forEach((m) => _(m)), x;
  }
  let w = {};
  class y {
    get content() {
    ...
    constructor(m, O, A) {
      ...
      this.result = new l(m, E, A), this.helpers = { ...w, postcss: w, result: this.result }, this.plugins = this.processor.plugins.map((b) => typeof b == "object" && b.prepare ? { ...b, ...b.prepare(this.result) } : b);
    }
    async() {
    ...
    handleError(m, O) {
      ...
      try {
        if (O && O.addToError(m), this.error = m, m.name === "CssSyntaxError" && !m.plugin)
          m.plugin = A.postcssPlugin, m.setMessage();
    ...
    sync() {
      ...
      if (this.prepareVisitors(), this.hasListener) {
        let m = this.result.root;
        for (; !m[c]; )
          m[c] = true, this.walkSync(m);
        if (this.listeners.OnceExit)
          if (m.type === "document")
            for (let O of m.nodes)
    ...
    walkSync(m) {
      ...
      for (let A of O)
        if (A === v)
          ...
          if (E && this.visitSync(E, m.toProxy()))
            return;
        }
    }
    warnings() {
  ...
  return y.registerPostcss = (x) => {
    w = x;
  }, Hr2 = y, y.default = y, f.registerLazyResult(y), a.registerLazyResult(y), Hr2;
}
var Jr;
var Ta;
function mu() {
  ...
  class f {
    ...
    constructor(c, t, e) {
      t = t.toString(), this.stringified = false, this._processor = c, this._css = t, this._opts = e, this._map = void 0;
      let r, i = p;
...
function Be() {
  ...
  return w.plugin = function(x, m) {
    let O = false;
    function A(...b) {
      console && console.warn && !O && (O = true, console.warn(
...
var xu = Le.Root;
Le.Node;
var Ou = (u) => u.replace(/\/\*[\s\S]*?\*\//gm, "").replace(/;\s+/gm, ";").replace(/:\s+/gm, ":").replace(/\)\s*{/gm, "){").replace(/\s+\(/gm, "(").replace(/{\s+/gm, "{").replace(/}\s+/gm, "}").replace(/\s*{/gm, "{").replace(/;?\s*}/gm, "}");
var Ni = (u) => {
  if (u.first === void 0) {
    const a = u.parent;
    a && (u.remove(), Ni(a));
...
function sr(u, a) {
  const h = import_react.default.Children.map(u, (p) => {
    if (import_react.default.isValidElement(p)) {
      const l = { ...p.props };
      p.props.children && !yl(p) && (l.children = sr(p.props.children, a));
      const f = a(
        import_react.default.cloneElement(p, l, l.children)
      );
      if (import_react.default.isValidElement(f) && (typeof f.type == "function" || // @ts-expect-error - we know this is a component that may have a render function
      f.type.render)) {
...
var wl = (u) => u.replaceAll("+", "plus").replaceAll("[", "").replaceAll("%", "pc").replaceAll("]", "").replaceAll("(", "").replaceAll(")", "").replaceAll("!", "imprtnt").replaceAll(">", "gt").replaceAll("<", "lt").replaceAll("=", "eq").replace(/^[0-9]/, (a) => Pu[a]).replace(/[^a-zA-Z0-9\-_]/g, "_");
var vt = { exports: {} };
var mt = { exports: {} };
var gt = { exports: {} };
var yt = { exports: {} };
...
function bl() {
  return Ia || (Ia = 1, function(u, a) {
    ...
    function h(f) {
      for (var s = f.toLowerCase(), c = "", t = false, e = 0; e < 6 && s[e] !== void 0; e++) {
...
function pr() {
  if (La) return Ye;
  La = 1, Ye.__esModule = true, Ye.unesc = Ye.stripComments = Ye.getProp = Ye.ensureObject = void 0;
  var u = l(bl());
  Ye.unesc = u.default;
  var a = l(Eu());
...
function Fe() {
  if (Fa) return Re;
  Fa = 1, Re.__esModule = true, Re.UNIVERSAL = Re.TAG = Re.STRING = Re.SELECTOR = Re.ROOT = Re.PSEUDO = Re.NESTING = Re.ID = Re.COMMENT = Re.COMBINATOR = Re.CLASS = Re.ATTRIBUTE = void 0;
  var u = "tag";
  Re.TAG = u;
  var a = "string";
  Re.STRING = a;
    ...
    var g = /* @__PURE__ */ function(n) {
      ...
      return _.append = function(y) {
        ...
        for (var m in this.indexes)
          x = this.indexes[m], x >= y && (this.indexes[m] = x - 1);
        return this;
        ...
        for (var O = this.index(y), A = [], E = 2; E < arguments.length; E++)
          A.push(arguments[E]);
        (m = this.nodes).splice.apply(m, [O + 1, 0, x].concat(A)), x.parent = this;
        var b;
        ...
        for (var O = this.index(y), A = [], E = 2; E < arguments.length; E++)
          A.push(arguments[E]);
        (m = this.nodes).splice.apply(m, [O, 0, x].concat(A)), x.parent = this;
        var b;
        for (var k in this.indexes)
        ...
        if (this.indexes[x] = 0, !!this.length) {
          for (var m, O; this.indexes[x] < this.length && (m = this.indexes[x], O = y(this.at(m), m), O !== false); )
            this.indexes[x] += 1;
  ...
  return Ua || (Ua = 1, function(u, a) {
    ...
    function f(r, i) {
      for (var o = 0; o < i.length; o++) {
        var v = i[o];
        v.enumerable = v.enumerable || false, v.configurable = true, "value" in v && (v.writable = true), Object.defineProperty(r, v.key, v);
      }
    }
    function s(r, i, o) {
...
function xl() {
  return Va || (Va = 1, function(u, a) {
    ...
    function t(o, v, g) {
      return v && c(o.prototype, v), Object.defineProperty(o, "prototype", { writable: false }), o;
    }
    function e(o, v) {
...
function Al() {
  ...
  function a(h) {
    try {
      if (!ta.localStorage) return false;
    } catch {
      return false;
    }
  ...
  return Ka || (Ka = 1, function(u) {
    ...
    function c(m, O) {
      for (var A = 0; A < O.length; A++) {
        var E = O[A];
        E.enumerable = E.enumerable || false, E.configurable = true, "value" in E && (E.writable = true), Object.defineProperty(m, E.key, E);
      }
    }
    function t(m, O, A) {
      return O && c(m.prototype, O), Object.defineProperty(m, "prototype", { writable: false }), m;
    }
    function e(m, O) {
    ...
    function d(m) {
      var O = false, A = null, E = m, b = E.match(o);
      return b && (A = b[1], E = b[2]), E = (0, h.default)(E), E !== m && (O = true), {
        deprecatedUsage: O,
        unescaped: E,
        quoteMark: A
      };
    ...
    function _(m) {
      if (m.quoteMark !== void 0 || m.value === void 0)
        return m;
      n();
    ...
    function g(n) {
      ...
      function L(F, D) {
        if (n.safe)
          ...
          throw n.error("Unclosed " + F, m, O - x, O);
      }
      for (; O < y; ) {
        switch (E = _.charCodeAt(O), E === a.newline && (x = O, m += 1), E) {
          ...
          case a.feed:
            C = O;
            do
              C += 1, E = _.charCodeAt(C), E === a.newline && (x = C, m += 1);
  ...
  return is || (is = 1, function(u, a) {
    ...
    var z = /* @__PURE__ */ function() {
      ...
      return F._errorGenerator = function() {
        ...
        var Q = (0, g.default)(B([0].concat(V, K)));
...
function Du() {
  if (ss) return Ie;
  ss = 1, Ie.__esModule = true, Ie.universal = Ie.tag = Ie.string = Ie.selector = Ie.root = Ie.pseudo = Ie.nesting = Ie.id = Ie.comment = Ie.combinator = Ie.className = Ie.attribute = void 0;
...
var Bu = (u, a) => {
  ...
  if (u.props.className) {
    ...
    p = t, l = c;
    const { styles: e, residualClassName: r } = Wu(
      u.props.className,
      s
    );
    if (h.style = {
  ...
  return hs || (hs = 1, function(u) {
    (function() {
      function a(l, f, s) {
        ...
        for (g = 0; g < n; g++)
          if (i = f[g], s && (i = i[s]), !!i && (a.caseSensitive ? o = i : o = i.toLowerCase(), v = p(l, o, e), (e === null || v < e) && (e = v, s && a.returnWinningObject ? r = f[g] : r = i, a.returnFirstMatch)))
            return r;
      ...
      function p(l, f, s) {
        ...
        for (i = 0; i <= c; i++)
          e[0][i] = i;
        for (r = 1; r <= t; r++) {
          for (o = h, v = 1, r > s && (v = r - s), g = t + 1, g > s + r && (g = s + r), i = 1; i <= c; i++)
            i < v || i > g ? e[r][i] = s + 1 : f.charAt(r - 1) === l.charAt(i - 1) ? e[r][i] = e[r - 1][i - 1] : e[r][i] = Math.min(
              e[r - 1][i - 1] + 1,
              // Substitute
              Math.min(
                e[r][i - 1] + 1,
  ...
  return dn = function(v) {
    for (var g = [], n = v, d, _, w, y, x, m, O, A, E = 0, b = n.charCodeAt(E), k = n.length, q = [
      ...
      if (b <= 32) {
        ...
        while (b <= 32);
        y = n.slice(E, d), w = g[g.length - 1], b === a && M ? C = y : w && w.type === "div" ? (w.after = y, w.sourceEndIndex += y.length) : b === s || b === c || b === f && n.charCodeAt(d + 1) !== t && (!W || W && W.type === "function" && false) ? P = y : g.push({
          type: "space",
          sourceIndex: E,
          sourceEndIndex: d,
          value: y
        ...
        d = n.indexOf("*/", E), y = {
          ...
          sourceIndex: E,
          sourceEndIndex: d + 2
        }, d === -1 && (y.unclosed = true, d = n.length, y.sourceEndIndex = d), y.value = n.slice(E + 2, d), g.push(y), E = d + 2, b = n.charCodeAt(E);
        ...
        if (A = E, y = {
          ...
          M += 1, y.after = "", y.sourceEndIndex = E + 1, g.push(y), q.push(y), g = y.nodes = [], W = y;
        S = "";
      } else if (a === b && M)
        E += 1, b = n.charCodeAt(E), W.after = C, W.sourceEndIndex += C.length, C = "", M -= 1, q[q.length - 1].sourceEndIndex = E, q.pop(), W = q[M], g = W.nodes;
      else {
        d = E;
        do
  ...
  return Cs || (Cs = 1, function(u) {
    ...
    function s(t) {
      return (0, h.splitAtTopLevelOnly)(t, ",").map((r) => {
        ...
        for (let n of v)
          f.lastIndex = 0, !g.has("KEYWORD") && p.has(n) ? (o.keyword = n, g.add("KEYWORD")) : f.test(n) ? g.has("X") ? g.has("Y") ? g.has("BLUR") ? g.has("SPREAD") || (o.spread = n, g.add("SPREAD")) : (o.blur = n, g.add("BLUR")) : (o.y = n, g.add("Y")) : (o.x = n, g.add("X")) : o.color ? (o.unknown || (o.unknown = []), o.unknown.push(n)) : o.color = n;
...
function mr() {
  return Rs || (Rs = 1, function(u) {
    ...
    function b(R) {
      let $ = 0;
      return (0, l.splitAtTopLevelOnly)(R, "_").every((z) => (z = t(z), z.startsWith("var(") ? true : E.has(z) || d(z) || v(z) ? ($++, true) : false)) ? $ > 0 : false;
    }
    function k(R) {
      let $ = 0;
  ...
  return qs || (qs = 1, function(u) {
    ...
    function c(i, o) {
      if (s.future.includes(o)) {
        var v, g, n;
        return i.future === "all" || ((n = (g = i == null || (v = i.future) === null || v === void 0 ? void 0 : v[o]) !== null && g !== void 0 ? g : f[o]) !== null && n !== void 0 ? n : false);
      }
      if (s.experimental.includes(o)) {
        var d, _, w;
        return i.experimental === "all" || ((w = (_ = i == null || (d = i.experimental) === null || d === void 0 ? void 0 : d[o]) !== null && _ !== void 0 ? _ : f[o]) !== null && w !== void 0 ? w : false);
      }
      return false;
    }
    function t(i) {
  ...
  return Ls || (Ls = 1, function(u) {
    ...
    function A(b, k, q, M) {
      ...
      if (v(k)) {
        ...
        if (!/^[\w-_]+$/g.test(P))
          C = S;
        else if (P !== void 0 && !m.includes(P))
          return [];
        if (C.length > 0 && m.includes(P))
          return [
            o(`[${C}]`, q),
            P,
            null
...
function yr() {
  if (Ws) return Qe;
  Ws = 1, Qe.__esModule = true, Qe.unesc = Qe.stripComments = Qe.getProp = Qe.ensureObject = void 0;
  var u = l(Bi());
  Qe.unesc = u.default;
  var a = l(ff());
...
function $e() {
  if (js) return Me;
  js = 1, Me.__esModule = true, Me.UNIVERSAL = Me.TAG = Me.STRING = Me.SELECTOR = Me.ROOT = Me.PSEUDO = Me.NESTING = Me.ID = Me.COMMENT = Me.COMBINATOR = Me.CLASS = Me.ATTRIBUTE = void 0;
  var u = "tag";
  Me.TAG = u;
  var a = "string";
  Me.STRING = a;
    ...
    var g = /* @__PURE__ */ function(n) {
      ...
      return _.append = function(y) {
        ...
        for (var A in this.indexes)
          O = this.indexes[A], m <= O && (this.indexes[A] = O + 1);
        return this;
      }, _.insertBefore = function(y, x) {
        x.parent = this;
        var m = this.index(y);
        ...
        var O;
        for (var A in this.indexes)
          O = this.indexes[A], O <= m && (this.indexes[A] = O + 1);
        return this;
      }, _._findChildAtPosition = function(y, x) {
        var m = void 0;
        return this.each(function(O) {
...
function gf() {
  if (fo) return De;
  fo = 1, De.__esModule = true, De.universal = De.tag = De.string = De.selector = De.root = De.pseudo = De.nesting = De.id = De.comment = De.combinator = De.className = De.attribute = void 0;
...
function yf() {
  if (co) return Ee;
  co = 1, Ee.__esModule = true, Ee.isComment = Ee.isCombinator = Ee.isClassName = Ee.isAttribute = void 0, Ee.isContainer = y, Ee.isIdentifier = void 0, Ee.isNamespace = x, Ee.isNesting = void 0, Ee.isNode = p, Ee.isPseudo = void 0, Ee.isPseudoClass = w, Ee.isPseudoElement = _, Ee.isUniversal = Ee.isTag = Ee.isString = Ee.isSelector = Ee.isRoot = void 0;
...
function bf() {
    ...
    return _.each((x) => {
      if (x.type === "nesting") {
        ...
        x.value !== "&" ? x.replaceWith(
          p(x.value.replace("&", m.toString()))
        ) : x.replaceWith(m), y = true;
      } else "nodes" in x && x.nodes && l(x, w) && (y = true);
    }), y;
  }
  function f(_, w) {
    let y = [];
    return _.selectors.forEach((x) => {
      ...
      w.selectors.forEach((O) => {
        if (!O)
          return;
        let A = p(O, w);
        l(A, m) || (A.prepend(h.combinator({ value: " " })), A.prepend(m.clone({}))), y.push(A.toString());
      });
    }), y;
  }
  function s(_, w) {
  ...
  function c(_) {
    return function w(y, x, m, O = m) {
      let A = [];
      if (x.each((E) => {
        E.type === "rule" && m ? O && (E.selectors = f(y, E)) : E.type === "atrule" && E.nodes ? _[E.name] ? w(y, E, O) : x[v] !== false && A.push(E) : A.push(E);
      }), m && A.length) {
        let E = y.clone({ nodes: [] });
        for (let b of A)
          E.append(b);
  ...
  function r(_) {
    ...
    if (y) {
      let x = y[1] === "with", m = Object.fromEntries(
        y[2].trim().split(/\s+/).map((A) => [A, true])
      );
      if (x && m.all)
        return { type: "noop" };
      let O = (A) => !!m[A];
      return m.all ? O = () => true : x && (O = (A) => A === "all" ? false : !m[A]), {
        escapes: O,
        type: "withrules"
      };
    }
  ...
  return ar.exports = (_ = {}) => {
    let w = e(
      ...
      _.unwrap
    ), m = (_.rootRuleName || "at-root").replace(/^@/, ""), O = _.preserveEmpty;
    return {
      Once(A) {
        A.walkAtRules(m, (E) => {
          n(E), A[d] = true;
      ...
      RootExit(A) {
        A[d] && (A.walkAtRules(m, o), A[d] = false);
      },
      Rule(A) {
        let E = false, b = A, k = false, q = [];
        A.each((M) => {
          M.type === "rule" ? (q.length && (b = t(A.selector, q, b), q = []), k = true, E = true, M.selectors = f(A, M), b = s(M, b)) : M.type === "atrule" ? (q.length && (b = t(A.selector, q, b), q = []), M.name === m ? (E = true, y(A, M, true, M[v]), b = s(M, b)) : w[M.name] ? (k = true, E = true, y(A, M, true), b = s(M, b)) : x[M.name] ? (k = true, E = true, y(A, M, false), b = s(M, b)) : k && q.push(M)) : M.type === "decl" && k && q.push(M);
      ...
      let ve = 0, Ae = {
        ...
        */
        ...
        matchVariant(ae, re, fe) {
          ...
          var qe;
          for (let [ge, pe] of Object.entries((qe = fe == null ? void 0 : fe.values) !== null && qe !== void 0 ? qe : {}))
            ge !== "DEFAULT" && Ae.addVariant(he ? `${ae}${ge}` : `${ae}-${ge}`, ({ args: Oe, container: Ue }) => re(pe, Ce ? {
          ...
          Ae.addVariant(ae, ({ args: ge, container: pe }) => {
            if ((ge == null ? void 0 : ge.value) === n.NONE && !Se)
              return null;
            var Oe;
      ...
      if (ce.length > 0) {
        ...
        if (re.length > 0) {
          ...
          for (let he of se) {
            ...
            for (let qe of Ce)
              for (let { pattern: me, variants: Se = [] } of re)
                if (me.lastIndex = 0, fe.has(me) || fe.set(me, 0), !!me.test(qe)) {
          ...
          if (Ce.variantInfo !== S.Base) {
            ...
            we.push({
              ...
              selectors({ modifier: qe, value: me } = {}) {
                ...
                var Sr;
                let ou = (Sr = Ce[M]) !== null && Sr !== void 0 ? Sr : {}, Xi = !(su || ou.respectPrefix === false);
  ...
  return Vo || (Vo = 1, function(u) {
    ...
    function* A(T) {
      ...
      for (; U >= 0; ) {
        ...
        } else U === 1 / 0 && T.includes("/") ? (j = T.lastIndexOf("/"), H = true) : j = T.lastIndexOf("-", U);
        if (j < 0)
          break;
    ...
    function k(T, U, j) {
      ...
      if (j.variantMap.has(T)) {
        ...
        let Q = J(T);
        var K;
        let ne = (K = (V = j.variantOptions.get(T)) === null || V === void 0 ? void 0 : V[v.INTERNAL_FEATURES]) !== null && K !== void 0 ? K : {}, de = j.variantMap.get(T).slice(), _e = [], be = !(Q || ne.respectPrefix === false);
        for (let [ie, ke] of U) {
          if (ie.layer === "user")
            continue;
    ...
    function* z(T, U) {
      for (const V of T) {
        ...
        V[1].raws.tailwind = {
          ...V[1].raws.tailwind,
          classCandidate: U,
          preserveSource: (H = (j = V[0].options) === null || j === void 0 ? void 0 : j.preserveSource) !== null && H !== void 0 ? H : false
        }, yield V;
      }
    }
    function* L(T, U) {
    ...
    function a(p, l = void 0, f = void 0) {
      return p.map((s) => {
        ...
        return f !== void 0 && (c.raws.tailwind = {
          ...
          var e;
          if (((e = t.raws.tailwind) === null || e === void 0 ? void 0 : e.preserveSource) === true && t.source)
            return false;
          t.source = l;
        }), c;
      });
  ...
  return Qo || (Qo = 1, function(u) {
    ...
    function f(r) {
      ...
      return (o) => {
        ...
        for (let n of i) {
          var g;
          for (let d of (g = o.match(n)) !== null && g !== void 0 ? g : [])
            v.push(e(d));
        }
    ...
    function e(r) {
      ...
      for (let g of v) {
        ...
        if (n === d ? o.pop() : (n === "'" || n === '"' || n === "`") && o.push(n), !d) {
          ...
          if (i < 0)
            return r.substring(0, g.index - 1);
          if (i === 0 && !t.test(n))
            return r.substring(0, g.index);
        }
      }
      return r;
    }
...
`))
        if (E = E.trim(), !A.has(E))
          if (A.add(E), d.get(m).has(E))
            for (let b of d.get(m).get(E))
              O.add(b);
          else {
...
function Hf() {
  return Xo || (Xo = 1, function(u) {
    ...
    function c(o) {
      let v = o.filter((y) => y.type !== "pseudo" || y.nodes.length > 0 ? true : y.value.startsWith("::") || [
        ":before",
        ":after",
        ":first-line",
        ":first-letter"
...
var Zf = Xf();
var ec = /* @__PURE__ */ He(Zf);
var tc = (u, a) => u instanceof Ra && a instanceof Ra ? u.selector === a.selector || a.selector.includes("*") || a.selector.includes(":root") : u === a;
    ...
    function f(s) {
      if ((() => {
        ...
        if (Array.isArray(s.content))
          return s.content.every((e) => typeof e == "string" ? true : !(typeof (e == null ? void 0 : e.raw) != "string" || e != null && e.extension && typeof (e == null ? void 0 : e.extension) != "string"));
        if (typeof s.content == "object" && s.content !== null) {
          ...
          if (Array.isArray(s.content.files)) {
            if (!s.content.files.every((e) => typeof e == "string" ? true : !(typeof (e == null ? void 0 : e.raw) != "string" || e != null && e.extension && typeof (e == null ? void 0 : e.extension) != "string")))
              return false;
      ...
      s.content = {
        ...
        extract: (() => {
          let e = (() => {
            ...
            if (!((g = s.content) === null || g === void 0 || (n = g.options) === null || n === void 0) && n.defaultExtractor)
    ...
    function A(M) {
      const W = (S, P) => {
        for (const C of O(S)) {
          let R = 0, $ = M;
          for (; $ != null && R < C.length; )
            $ = $[C[R++]], $ = g($) && (C.alpha === void 0 || R <= C.length - 1) ? $(W, d) : $;
          if ($ !== void 0) {
            if (C.alpha !== void 0) {
...
function hc() {
  ...
  fl = 1;
  let u = pc();
  return Ti = (u.__esModule ? u : { default: u }).default, Ti;
}
var vc = hc();
var mc = /* @__PURE__ */ He(vc);
...
var Sc = ({ children: u, config: a }) => {
  ...
  if (ku(p), f) {
    ...
    if (s = sr(s, (t) => {
      if (c)
        return t;
      if (kr.isValidElement(t) && t.type === "head") {
        c = true;
        const e = /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("style", { children: Ou(p.toString().trim()) });
        return kr.cloneElement(
          t,
          t.props,
          t.props.children,
          e
...
var Text = React11.forwardRef(
  (_a2, ref) => {
    var _b = _a2, { style } = _b, props = __objRest11(_b, ["style"]);
    let modifiedStyle = {};
    ...
    modifiedStyle = __spreadValues11(__spreadValues11({}, modifiedStyle), style);
...
var ProfileUpdateEmail = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Html, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Preview, { children: "Th\xF4ng tin t\xE0i kho\u1EA3n c\u1EE7a b\u1EA1n \u0111\xE3 \u0111\u01B0\u1EE3c c\u1EADp nh\u1EADt" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Sc, { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Body, { className: "bg-gray-100 font-sans", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Container, { className: "mx-auto my-10 max-w-[600px] rounded-lg bg-white p-8 shadow-lg", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Section, { style: { background: "linear-gradient(90deg, #2563eb 0%, #60a5fa 100%)", borderRadius: 12, padding: "24px 0 12px 0", marginBottom: 24 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Heading, { style: { color: "#fff", fontWeight: 700, fontSize: 26, margin: 0 }, children: "Th\xF4ng tin t\xE0i kho\u1EA3n \u0111\xE3 \u0111\u01B0\u1EE3c c\u1EADp nh\u1EADt" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Section, { className: "text-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Text, { className: "text-gray-600", children: [
          "Xin ch\xE0o ",
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { style: { fontWeight: "bold", display: "inline" }, children: name }),
          ","
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Text, { className: "mt-2 text-gray-600", children: [
          "Th\xF4ng tin t\xE0i kho\u1EA3n c\u1EE7a b\u1EA1n t\u1EA1i Sport Store \u0111\xE3 \u0111\u01B0\u1EE3c c\u1EADp nh\u1EADt th\xE0nh c\xF4ng v\xE0o l\xFAc ",
          time,
          "."
        ] })
      ] }),
      changes.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Section, { className: "mt-8", style: { border: "2px solid #2563eb", borderRadius: 10, boxShadow: "0 2px 8px 0 #2563eb22", background: "#f3f4f6", padding: 20 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Heading, { style: { color: "#2563eb", fontWeight: 600, fontSize: 18, marginBottom: 12 }, children: "Th\xF4ng tin \u0111\xE3 c\u1EADp nh\u1EADt" }),
        changes.map((change, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Section, { style: { background: index % 2 === 0 ? "#f9fafb" : "#fff", padding: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Text, { style: { fontWeight: "bold", display: "inline", marginRight: 8 }, children: [
            change.field,
            ":"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { style: { display: "inline" }, children: change.value })
        ] }, index))
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Section, { className: "mt-8 rounded-lg bg-green-50 p-6", style: { border: "2px solid #22c55e", boxShadow: "0 2px 8px 0 #22c55e22" }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { className: "text-center text-green-700", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { style: { fontWeight: "bold", display: "inline" }, children: "C\u1EADp nh\u1EADt th\xF4ng tin th\xE0nh c\xF4ng!" }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Section, { className: "mt-8 rounded-lg bg-yellow-50 p-4", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Text, { className: "text-sm text-yellow-700", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { style: { fontWeight: "bold", display: "inline" }, children: "L\u01B0u \xFD b\u1EA3o m\u1EADt:" }),
        " N\u1EBFu b\u1EA1n kh\xF4ng th\u1EF1c hi\u1EC7n thay \u0111\u1ED5i n\xE0y, vui l\xF2ng li\xEAn h\u1EC7 ngay v\u1EDBi ch\xFAng t\xF4i."
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Section, { className: "mt-8 text-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          Link,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Text, { className: "mt-6 text-sm text-gray-600", children: [
          "C\u1EA7n h\u1ED7 tr\u1EE3? H\xE3y li\xEAn h\u1EC7 v\u1EDBi ch\xFAng t\xF4i qua email: ",
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Link, { href: "mailto:support@sportstore.com", className: "text-blue-600 underline", children: "support@sportstore.com" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Hr, { style: { borderTop: "1.5px solid #e5e7eb", margin: "32px 0 16px 0" } }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Section, { className: "text-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { className: "text-xs text-gray-500", children: "\xA9 2025 Sport Store. T\u1EA5t c\u1EA3 c\xE1c quy\u1EC1n \u0111\u01B0\u1EE3c b\u1EA3o l\u01B0u." }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Text, { className: "mt-1 text-xs text-gray-500", children: "\u0110\u1ECBa ch\u1EC9: 97 \u0110\u01B0\u1EDDng V\xF5 V\u0103n T\u1EA7n, Ph\u01B0\u1EDDng 6, Qu\u1EADn 3, Th\xE0nh ph\u1ED1 H\u1ED3 Ch\xED Minh" })
      ] })
    ] }) }) })
  ] });
};
