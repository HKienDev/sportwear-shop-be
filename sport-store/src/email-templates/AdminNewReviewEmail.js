  ...
  return jsxs(Html, { children: [
    ...
    jsxs(Body, { style: main, children: jsxs(Container, { style: container, children: [
      jsxs(Section, { style: header, children: [
        jsx(Heading, { style: h1, children: "Đánh giá mới!" }),
        ...
        jsx(Heading, { style: h2, children: "Đánh giá từ user" }),
        jsxs(Text, { style: ratingText, children: [
          jsx("strong", { children: "Điểm đánh giá:" }),
          " ",
          "⭐".repeat(rating),
          " (",
          rating,
        ...
        jsxs(Text, { style: commentText, children: [
          jsx("strong", { children: "Nhận xét:" }),
          " ",
          comment
        ] })
      ] }),
...
export default AdminNewReviewEmail; 